...
public partial class MetaContext {
    ...
    public MetaEntity SetTimeService(ITimeService newTimeService) {
        if (hasTimeService) {
        ...
        entity.AddTimeService(newTimeService);
        return entity;
    }

    public void ReplaceTimeService(ITimeService newTimeService) {
        var entity = timeServiceEntity;
        if (entity == null) {
            entity = SetTimeService(newTimeService);
        } else {
            entity.ReplaceTimeService(newTimeService);
        }
    }
...
public partial class MetaEntity {
    ...
    public void AddTimeService(ITimeService newTimeService) {
        ...
        component.TimeService = newTimeService;
